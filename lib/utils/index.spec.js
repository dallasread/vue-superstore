...
describe('Utils', () => {
  it('singularize', () => {
    expect(Utils.singularize('person')).toEqual('person')
    expect(Utils.singularize('people')).toEqual('person')
  ...
  it('pluralize', () => {
    expect(Utils.pluralize('person')).toEqual('people')
    expect(Utils.pluralize('people')).toEqual('people')
